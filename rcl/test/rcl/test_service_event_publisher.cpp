  ...
  test_service_event_publisher_send_message_nominal)
{
  ...
  ret = rcl_service_introspection_enable_content(&service_event_publisher, true);
  ASSERT_EQ(RCL_RET_OK, ret) << rcl_get_error_string().str;
...
public:
  ...
  void SetUp()
  {
    ...
    *this->node_ptr = rcl_get_zero_initialized_node();
    ...
    ret = rcl_service_introspection_configure_server_service_event_message_payload(&service, true);
    ASSERT_EQ(RCL_RET_OK, ret) << rcl_get_error_string().str;
    ...
    ret = rcl_service_introspection_configure_client_service_event_message_payload(&client, true);
    ASSERT_EQ(RCL_RET_OK, ret) << rcl_get_error_string().str;
